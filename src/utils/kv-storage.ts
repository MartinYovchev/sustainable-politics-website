...
class VercelKVClient {
  ...
  constructor() {
    ...
    this.baseUrl = import.meta.env.UPSTASH_REDIS_REST_URL || process.env.VITE_KV_REST_API_URL || ""
    this.token = import.meta.env.UPSTASH_REDIS_REST_TOKEN || process.env.VITE_KV_REST_API_TOKEN || ""
